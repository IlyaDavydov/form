...
i1.addEventListener("click", function(event) {
    ...
    if (i1.src.includes("eye_slash_blue.svg")) {
        i1.src = "eye_blue.svg";
        pasOne.type = "text";
        pasOne.classList.add("input-one-pas");
    } else if (i1.src.includes("eye_blue.svg")) {
        i1.src = "eye_slash_blue.svg";
        pasOne.type = "password";
    } else if (i1.src.includes("eye_slash_pink.svg")) {
        i1.src = "eye_pink.svg";
        pasOne.type = "text";
        pasOne.classList.add("input-one-pas");
    } else if (i1.src.includes("eye_pink.svg")) {
...
i2.addEventListener("click", function(event) {
    event.stopPropagation();
    if (i2.src.includes("eye_slash_blue.svg")) {
        i2.src = "eye_blue.svg";
        pasTwo.type = "text";
    ...
    } else if (i2.src.includes("eye_slash_pink.svg")) {
        i2.src = "eye_pink.svg";
        pasTwo.type = "text";
        pasTwo.classList.add("input-one-pas");
    } else if (i2.src.includes("eye_pink.svg")) {
